...
\codedataavailability{The benchmark table, official splits, build manifest, and baseline leaderboard are archived on Zenodo at https://doi.org/10.5281/zenodo.21232229 (version DOI of the v0.4 release described in this paper; cite this identifier for exact reproducibility). The concept DOI https://doi.org/10.5281/zenodo.21208651 always resolves to the latest version. Both are released under CC-BY-4.0. The assembly and evaluation pipeline is the open-source (MIT) \texttt{terraflow.drought} sub-package of TerraFlow (https://github.com/gmarupilla/AgroTerraFlow); the exact release used to build this dataset is archived as TerraFlow v0.6.0 at https://doi.org/10.5281/zenodo.21735915. Upstream inputs are public: USDA RMA Cause of Loss and Summary-of-Business files, USDA-NASS QuickStats, and the flashdry predictor corpus (derived from MODIS NDVI, ERA5-Land, Daymet, and the US Drought Monitor).}
